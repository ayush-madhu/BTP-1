...
from process_images import clear_output_directory, process_images
import cv2
...
def static_mode():
    ...
    if uploaded_file is not None:
        ...
        (
            ...
            n,
            images_to_display,
        ) = process_images(uploaded_file, threshold_value, 0)
        ...
        if st.button("OK"):
            ...
            # Combine all captions for the extracted images to display in the app interface
            ...
            while True:
                ...
                for image_path in images_to_display:
                    static_placeholder.image(
                        image_path, caption=captions[count], use_column_width=True
                    )
                    count += 1
                    time.sleep(2)
